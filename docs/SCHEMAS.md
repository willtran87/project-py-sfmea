...
| `static_branch_model` | `pysfmea-static-branch-model-1` | Count-reconciled, component-linked safe static decisions for literal/boolean/`TYPE_CHECKING` branches and short-circuit operands pruned before downstream call, exception, sequence, and failure-mode composition |
