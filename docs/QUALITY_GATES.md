...
flowchart LR
  ...
  S --> H["10,000-record-capable HTML generation"]
  ...
  LSTRAT --> L25["25 replayed campaign gates"]
  R --> L14
  R --> L15
  R --> L25
...
| Scale reporting | Failure to retain the governed scale analysis, generate a self-contained report with a 10,000-record cap, load it in Chromium, exercise its navigation, or verify the browser evidence | The deterministic generated fixture is a repeatable product regression test; CI does not claim 50,000-record browser qualification or representative analyst usability. |
