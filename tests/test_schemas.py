    ...
    def test_catalog_is_deterministic_and_content_addressed(self) -> None:
        ...
        self.assertEqual(
            ...
            [
                ...
                "fuzz-campaign",
                "fuzz-campaign-verification",
                "golden-corpus",
                "gsn-projection",
                "gsn-projection-verification",
                "html-report-verification",
                "independent-benchmark-assessment",
                "independent-benchmark-assessment-v2",
                "independent-benchmark-report-verification-v2",
                "independent-benchmark-verification",
                "independent-benchmark-verification-v2",
                "independent-roundtrip-evidence",
                "independent-roundtrip-verification",
                "industry-benchmark-catalog",
                "industry-exchange-verification",
                "industry-validation-portfolio-assessment",
                "industry-validation-portfolio-report-verification",
                "industry-validation-portfolio-source",
                "industry-validation-portfolio-verification",
                "json-evidence-signature",
                "json-evidence-signature-verification",
                "laboratory-governance-assessment",
                "laboratory-governance-source",
                "laboratory-governance-verification",
                "lifecycle-model",
                "lifecycle-model-verification",
                "normative-schema-validation",
                "normative-schema-validation-verification",
                "oscal-assessment-results",
                "oscal-assessment-results-verification",
                "plugin-manifest",
                "plugin-request",
                "plugin-response",
                "plugin-run",
                ...
                "quality-evaluation-source",
                "quality-evaluation-verification",
                "quantitative-fta-assessment",
                "quantitative-fta-source",
                "quantitative-fta-verification",
                "release-qualification-assessment",
                "release-qualification-source",
                "release-qualification-verification",
                "report-browser-quality",
                "report-browser-quality-verification",
                "review-package-manifest",
                "review-package-verification",
                "runtime-coverage-observation",
                "runtime-coverage-observation-verification",
                "safety-lifecycle-assessment",
                "safety-lifecycle-authoring",
                "safety-lifecycle-verification",
                "sarif-fusion",
                "sarif-fusion-verification",
                "schema-bundle-verification",
                "schema-catalog",
                "security-prioritization-assessment",
                "security-prioritization-source",
                "security-prioritization-verification",
                "sfta-authoring",
                "sfta-authoring-apply-receipt",
                "sfta-authoring-draft",
                "sfta-authoring-verification",
                "slsa-policy-assessment",
                "slsa-policy-verification",
                "slsa-provenance",
                "slsa-provenance-verification",
                "slsa-trust-policy",
                "slsa-verification-observation",
                "ssvc-assessment",
                "ssvc-observations",
                "ssvc-policy",
                "ssvc-verification",
                ...
                "stpa-cast-assessment",
                "stpa-cast-source",
                "stpa-cast-verification",
                "structural-coverage-assessment",
                "structural-coverage-source",
