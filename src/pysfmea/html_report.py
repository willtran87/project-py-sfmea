...
<main class="main" id="mainContent" tabindex="-1">
  ...
  <div class="content">
    ...
    <section class="view" data-view="cross-reference" hidden><div class="section-head"><div><h2>Cross-reference evidence fabric</h2><p>One deterministic chain across scanner relationships, runtime observations, guidance, SFTA, findings, verification obligations, executions, and evidence.</p></div><button class="btn no-print" data-open-diagram="cross-reference-evidence-fabric">Open evidence diagram</button></div><div class="notice"><strong>Interpretation boundary:</strong> Populated links and multi-source agreement improve review leverage; they do not establish completeness, compliance, verification success, or risk acceptance.</div><div class="metrics" id="crossReferenceMetrics"></div><div class="grid"><div class="card"><div class="card-head"><div><h3>Relationship consensus</h3><p>Independent channels fused by directed component pair.</p></div></div><div class="bars" id="crossReferenceConsensus"></div></div><div class="card"><div class="card-head"><div><h3>Prioritized discrepancies</h3><p>Scanner disagreement and missing cross-model links that deserve review.</p></div></div><div class="citation-list" id="crossReferenceLeads"></div></div></div><div class="card" style="margin-top:16px"><div class="card-head"><div><h3>Finding-to-evidence chains</h3><p>Lowest linkage-completeness chains are shown first. Completeness is relationship accounting only.</p></div></div><div class="citation-list" id="crossReferenceChains"></div></div><div class="card" style="margin-top:16px"><div class="card-head"><h3>Authority and limits</h3></div><ul id="crossReferenceLimits"></ul><p class="small mono" id="crossReferenceBinding"></p></div></section>
