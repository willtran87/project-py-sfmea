    ...
    return {
        ...
        "interface_reconciliation": {
            **analysis.get("interface_reconciliation", {}),
            ...
            "matches": analysis.get("interface_reconciliation", {}).get(
                "matches", []
            )[:1000],
            "report_projection": {
    ...
    *,
    ...
    if (
        ...
        raise ValueError(
            ...
            f"{MAX_HTML_REPORT_VERIFY_BYTES}"
        )
