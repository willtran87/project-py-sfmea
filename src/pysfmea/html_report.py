...
def export_html_report(
    ...
    *,
    ...
    return atomic_publish_text(
        destination,
        document,
        max_bytes=MAX_HTML_REPORT_VERIFY_BYTES,
        label="HTML report",
    )
