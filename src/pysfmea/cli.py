    ...
    if args.json:
        ...
        if result.get("cross_reference"):
            ...
            print(
                ...
                "verification-readiness-profiles="
                f"{fabric.get('verification_readiness_profile_count', 0)}, "
                "review-governance-profiles="
                f"{fabric.get('review_governance_profile_count', 0)}, "
                f"quality-diagnostics={fabric.get('quality_gate_diagnostic_count', 0)}, "
                f"adapter-runs={fabric.get('adapter_run_count', 0)}, "
...
def _cross_reference_verify(args: argparse.Namespace) -> int:
    ...
    if args.json:
        ...
        print(
            ...
            "verification-readiness-profiles="
            f"{verification.get('verification_readiness_profile_count', 0)}, "
            "review-governance-profiles="
            f"{verification.get('review_governance_profile_count', 0)}, "
            "analysis-sections="
            f"{verification.get('analysis_section_count', 0)}, "
            "unmapped-analysis-sections="
            f"{verification.get('unmapped_analysis_section_count', 0)}, "
            "registered-without-projection="
            f"{verification.get('registered_without_projection_analysis_section_count', 0)}, "
            "analysis-projection-coverage="
            f"{verification.get('analysis_projection_coverage_percent', 0)}%, "
            "material-projection-coverage="
            f"{verification.get('analysis_material_projection_coverage_percent', 0)}%, "
            "analysis-records="
            f"{verification.get('analysis_record_count', 0)}, "
            "unresolved-analysis-records="
            f"{verification.get('unresolved_analysis_record_count', 0)}, "
            "record-projection-coverage="
            f"{verification.get('analysis_record_projection_coverage_percent', 0)}%, "
            "quality-diagnostics="
            ...
            "machine-suggestions="
            f"{verification.get('machine_suggestion_count', 0)}, "
            "machine-summaries="
            f"{verification.get('machine_summary_count', 0)}, "
            "machine-claim-relationships="
            f"{verification.get('machine_claim_relationship_count', 0)}, "
            f"guidance-sources={verification.get('guidance_source_count', 0)}, "
            f"guidance-citations={verification.get('guidance_citation_count', 0)}, "
            "complete-guidance-lineage-findings="
            f"{verification.get('complete_guidance_lineage_finding_count', 0)}, "
            "system-context-fields="
            f"{verification.get('system_context_field_count', 0)}, "
            "finding-context-claims="
            f"{verification.get('finding_context_claim_count', 0)}, "
            f"lifecycle-events={verification.get('lifecycle_event_count', 0)}, "
