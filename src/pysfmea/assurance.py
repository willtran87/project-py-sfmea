...
from .interfaces import AssuranceObligation, AssuranceRegister, FindingRecord
...
def _obligation(item: FindingRecord, baseline_id: str) -> AssuranceObligation:
    ...
    obligation["automation"]["fault_injection_plugins"] = recommended_fault_plugins(
        obligation
    )
    if upstream_paths:
