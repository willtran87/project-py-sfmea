...
BUILTIN_ADAPTERS = (
    AdapterDescriptor("python.repository_discoverer", "discoverer", "6", ("python_source", "test_inventory", "bounded_walk", "symlink_rejection", "non_regular_refusal", "identity_stable_artifact_snapshots", "analysis_source_snapshot_reuse", "test_evidence_snapshot_reuse", "dependency_snapshot_reuse", "interface_contract_snapshot_reuse", "coverage_snapshot_reuse", "test_evidence_manifest_binding", "configured_test_evidence_scope", "snapshot_provenance", "consumption_bounded_hashing", "aggregate_hash_limit"), "repository-path-1", "repository-inventory-1", "deterministic"),
    AdapterDescriptor("web.language_boundary_indexer", "analyzer", "1", ("typescript_imports", "javascript_imports", "exports", "external_packages", "literal_http_and_event_endpoints", "bounded_lexical_extraction", "explicit_semantic_limitations"), "repository-artifact-snapshot-1", "pysfmea-language-boundary-facts-1", "heuristic"),
    AdapterDescriptor("python.ast_parser", "parser", "2", ("functions", "methods", "classes", "lambdas", "module_initialization", "exact_byte_source_snapshots", "pep_263_decoding", "identity_reconciliation", "single_snapshot_baseline_binding"), "python-source-1", "python-ast-facts-1", "deterministic"),
