"""Minimal dependency-free PySFMEA process plugin."""
        ...
        "observations": [
            {
                ...
                "subject_id": "project",
                "message": f"The bounded request contains {len(components)} components.",
                "evidence_ids": [
                    value.get("id", "") for value in components[:10] if value.get("id")
                ],
                "confidence": "high",
